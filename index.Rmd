...
1. [Introduction: What is "Simulation-based Inference for Epidemiological Dynamics?"](./intro/intro.html)&nbsp;&nbsp;&nbsp;[(**R** script)](http://raw.githubusercontent.com/kingaa/sbied/gh-pages/intro/intro.R)
1. [Dynamic models and their simulation by Euler's method.](./stochsim/stochsim.html)&nbsp;&nbsp;&nbsp;[(**R** script)](http://raw.githubusercontent.com/kingaa/sbied/gh-pages/stochsim/stochsim.R)
1. [Likelihood for POMPs: theory and practice](./pfilter/pfilter.html)&nbsp;&nbsp;&nbsp;[(**R** script)](http://raw.githubusercontent.com/kingaa/sbied/gh-pages/pfilter/pfilter.R)
...
1. [Case study I: polio.](./polio/polio.html)&nbsp;&nbsp;&nbsp;[(**R** script)](http://raw.githubusercontent.com/kingaa/sbied/gh-pages/polio/polio.R)
1. [Case study II: measles.](./measles/measles.html)&nbsp;&nbsp;&nbsp;[(**R** script)](http://raw.githubusercontent.com/kingaa/sbied/gh-pages/measles/measles.R)
1. [Case study III: sexual contacts panel data](./contacts/contacts.html)&nbsp;&nbsp;&nbsp;[(**R** script)](http://raw.githubusercontent.com/kingaa/sbied/gh-pages/contacts/contacts.R)
1. [Case study IV: Ebola and forecasting](./ebola/ebola.html)&nbsp;&nbsp;&nbsp;[(**R** script)](http://raw.githubusercontent.com/kingaa/sbied/gh-pages/ebola/ebola.R)
